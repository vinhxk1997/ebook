...
<div class="stories">
    <div class="container">
        <div class="header py-3">
            <h1>{{ trans('tran.category') }}:&nbsp{{ $meta->name }}</h1>
        </div>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="new-tab" data-toggle="tab" href="#new" role="tab" aria-controls="new"
                        aria-selected="false"
                        data-url="{{ route('meta_new_stories', ['slug' => $meta->slug]) }}">@lang('app.new')</a>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-pane fade show active" id="hot" role="tabpanel" aria-labelledby="hot-tab">
                ...
                <div class="row">
                    <div class="col-sm-6 offset-sm-3">
                        <button class="btn btn-light btn-block on-show-more"
                            data-url="{{ $meta->stories->nextPageUrl() }}" data-target="#metaStories">
                            @lang('app.show_more')
